...
export const registerSchema = zod.object({
    ...
    name: zod.string().min(1, "This field is required").max(30, "Must be 30 or fewer characters long"),
    surname: zod.string().min(1, "This field is required").max(30, "Must be 30 or fewer characters long"),
});
